...
suite "mmops - Multimedia Operators Test Suite":
  ...
  suite "Nim-style Aliases":
    test "initMm functions":
      ...
      let zero_init = initMm(Mm[w32, float32])
